...
<body class="bg-[#090a0f] text-gray-200 min-h-screen flex items-center justify-center p-6 selection:bg-white selection:text-black antialiased">
    ...
    <div class="w-full max-w-md bg-[#0e1017] border border-zinc-800/80 rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <div class="space-y-1.5">
            ...
            <p class="text-sm text-zinc-500 font-normal">Enter your playground instance credentials<br>Email : csrf@lab.com<br> Pass : csrf</p>
        </div>
        ...
        <form id="form" action="/login" method="POST" class="space-y-4">
            <div class="space-y-1.5">
                ...
                <p id="outputEmail" class="text-xs font-medium text-rose-400/90 pt-1.5 min-h-[1.25rem] empty:hidden transition-all duration-150 ease-in-out"></p>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <input id="password" type="password" name="password" placeholder="••••••••"
                    class="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-zinc-800 rounded-lg text-white text-sm placeholder-zinc-600 focus:outline-none focus:border-zinc-500 focus:bg-zinc-900/80 transition-all">
                <p id="outputPassword" class="text-xs font-medium text-rose-400/90 pt-1.5 min-h-[1.25rem] empty:hidden transition-all duration-150 ease-in-out"></p>
