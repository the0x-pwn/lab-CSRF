...
<body
    ...
    <div class="w-full max-w-md bg-[#0e1017] border border-zinc-800/80 rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <div class="space-y-1.5">
            ...
            <p class="text-sm text-zinc-500 font-normal">Enter your playground instance credentials<br>
            <p class="text-sm font-sm text-red-400">
                Victim Account<br>
                Email: victim@lab.com<br>
                Pass: csrf
            </p>
            <p class="text-sm font-medium text-green-400">
                Attacker Account<br>
                Email: attacker@lab.com<br>
                Pass: attacker
            </p>
            </p>
        </div>
