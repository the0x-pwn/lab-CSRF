    ...
    <body class="bg-[#090a0f] text-gray-200 min-h-screen flex selection:bg-white selection:text-black antialiased"
        ...
        <script>
            ...
            var lines = [
                ...
                '    <span style="color:#569cd6;">&lt;form</span> <span style="color:#9cdcfe;">id</span>=<span style="color:#ce9178;">"csrfForm"</span> <span style="color:#9cdcfe;">action</span>=<span style="color:#ce9178;">"http://localhost/update-email"</span> <span style="color:#9cdcfe;">method</span>=<span style="color:#ce9178;">"POST"</span> <span style="color:#9cdcfe;">style</span>=<span style="color:#ce9178;">"display: none;"</span><span style="color:#569cd6;">&gt;</span>',
